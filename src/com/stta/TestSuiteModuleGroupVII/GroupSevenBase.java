package com.stta.TestSuiteModuleGroupVII;
...
public class GroupSevenBase extends SuiteBase{
	...
	public void checkSuiteToRun() throws IOException{
		...
		SuiteName = "TestSuiteModuleGroupVII";
		ToRunColumnName = "SuiteToRun";
		
		//Write to Logfile
		Add_Log.info("Module Group VII (Payments, Refunds and Exemptions Module Completed)");
		Add_Log.info("----------------------------------------------------------------------------------");
