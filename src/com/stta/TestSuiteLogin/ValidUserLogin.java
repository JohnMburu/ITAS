...
public class ValidUserLogin<WebeElement> extends LoginBase{
	...
	@Test(dataProvider="LoginCaseOneData")
	public void LoginCaseOneTest(String DataCol1,String DataCol2,String DataCol3,String DataCol4){
...
//Begin Login Cases
//This Test Case checks if Login Passes
//--------------------------------------------------------------------------------------
Add_Log.info("-------------------- Data -------------------------");
...
Add_Log.info("-----------------Starting Test Case Script Execution--------------------");
		...
		getElementByName("submit").click();
	    driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	    String ActualResultString = getElementByID("LoginOffice").getAttribute("name");
...
//---------------------------------------------------------------------------------------------------------------		
	...
	@DataProvider
	public Object[][] LoginCaseOneData(){
