package com.stta.TestSuiteModuleGroupX;
...
public class GroupTenBase extends SuiteBase{
	...
	public void checkSuiteToRun() throws IOException{
		...
		SuiteName = "TestSuiteModuleGroupX";
		ToRunColumnName = "SuiteToRun";
		
		//Write to Logfile
		Add_Log.info("Execution started for Module Group X (Other Taxpayer Services  - Applications, Certificates, FAQ, Knowledge Base)");
		Add_Log.info("-----------------------------------------------------------------------------------------------------------------------");
