package com.stta.TestSuiteModuleGroupVIII;
...
public class GroupEightBase extends SuiteBase{
	...
	public void checkSuiteToRun() throws IOException{
		...
		SuiteName = "TestSuiteModuleGroupVIII";
		ToRunColumnName = "SuiteToRun";
		
		//Writing to logfile
		Add_Log.info("Execution started for Module Group VIII (Audit Scheduling and Execution, Appeals, Objections, and Debt Management) **");
		Add_Log.info("-----------------------------------------------------------------------------------------------------------------------");
