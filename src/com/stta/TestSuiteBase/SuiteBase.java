...
public class SuiteBase {	
	...
	public static Read_XLS TestCaseListExcelNine=null;
	public static Read_XLS TestCaseListExcelTen=null;
	...
	public void init() throws IOException{
		...
		TestCaseListExcelTwo = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteModuleGroupII.xls");
		TestCaseListExcelThree = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteModuleGroupIII.xls");
		TestCaseListExcelFour = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteModuleGroupIV.xls");
		TestCaseListExcelFive = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteModuleGroupV.xls");
		TestCaseListExcelSix = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteModuleGroupVI.xls");
		TestCaseListExcelSeven = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteModuleGroupVII.xls");
		TestCaseListExcelEight = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteModuleGroupVII.xls");
		TestCaseListExcelNine = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteModuleGroupIX.xls");
		TestCaseListExcelTen = new Read_XLS(System.getProperty("user.dir")+"\\src\\com\\stta\\ExcelFiles\\SuiteModuleGroupX.xls");
	...
	public void loadWebBrowser(){
		//Check If any previous webdriver browser Instance  exists then run new test In that existing webdriver browser Instance.
