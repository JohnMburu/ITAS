package com.stta.TestSuiteModuleGroupII;
...
public class GroupTwoBase extends SuiteBase{
	...
	public void checkSuiteToRun() throws IOException{
		...
		SuiteName = "TestSuiteModuleGroupII";
		ToRunColumnName = "SuiteToRun";
		//Write to Log file
		Add_Log.info("------------------------------------------------------------------------------");
		Add_Log.info("Execution started for Module Group II (Registration and Property Information)");
		Add_Log.info("------------------------------------------------------------------------------");
